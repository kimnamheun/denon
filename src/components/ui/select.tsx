...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      // 노년 친화: 아이템 높이/패딩 키움, text-base
      "relative flex w-full cursor-default select-none items-center rounded-md py-2.5 pl-9 pr-3 text-base outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className,
    )}
    {...props}
  >
